...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_expr_stmt = 19,                 /* expr_stmt  */
...
{
       0,    27,    27,    29,    33,    34,    35,    39,    47,    54,
      61,    62,    63,    67,    68,    74,    78,    79,    89
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PRINT", "'+'", "'-'", "'*'", "'/'", "'='", "';'", "'('", "')'",
  "$accept", "program", "statement", "assignment", "print_stmt",
  "expr_stmt", "expression", "term", "factor", YY_NULLPTR
};
...
{
     -11,     0,   -11,   -11,    -4,    -1,    -2,   -11,   -11,   -11,
     -11,    15,    22,   -11,    -2,    -2,   -11,     7,    -2,    -2,
     -11,    -2,    -2,    21,    11,   -11,    22,    22,   -11,   -11,
     -11,     8,   -11
};
...
{
       2,     0,     1,    16,    17,     0,     0,     3,     4,     5,
       6,     0,    12,    15,     0,     0,    17,     0,     0,     0,
       9,     0,     0,     0,     0,    18,    10,    11,    13,    14,
       7,     0,     8
};
...
{
       2,     3,    16,     3,     4,     5,    14,    17,    26,    27,
       6,    15,     6,    18,    19,    23,    24,    18,    19,    32,
      25,    18,    19,     0,    31,     0,    20,    18,    19,     0,
      21,    22,    30,    28,    29
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     3,     4,     5,    10,     6,    18,    19,
      12,    12,    12,     6,     7,    14,    15,     6,     7,    11,
      13,     6,     7,    -1,    13,    -1,    11,     6,     7,    -1,
       8,     9,    11,    21,    22
};
...
{
       0,    15,     0,     3,     4,     5,    12,    16,    17,    18,
      19,    20,    21,    22,    10,    12,     4,    20,     6,     7,
      11,     8,     9,    20,    20,    13,    21,    21,    22,    22,
      11,    13,    11
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 7: /* assignment: IDENTIFIER '=' expression ';'  */
#line 40 "parser.y"
    {
      symtab_set((yyvsp[-3].id), (yyvsp[-1].intval));
      free((yyvsp[-3].id));
    }
#line 1100 "parser.tab.c"
    break;

  case 8: /* print_stmt: PRINT '(' expression ')' ';'  */
#line 48 "parser.y"
    {
      printf("%d\n", (yyvsp[-2].intval));
    }
